jQuery.noConflict(),
    jQuery(document).ready
        (function () {
            ...
            if (jQuery(".tab-box .tab-content").hide(),
                ...
                jQuery("#tabnav ul li").click(function () {
                    jQuery("#tabnav ul li").removeClass("active"),
                        jQuery(this).addClass("active"), jQuery(".tab-content").hide();
            ...
            jQuery(window).width() < 480 && (jQuery(".featured-products").find(".col-xs-6").removeClass("col-xs-6"),
                jQuery(".hot-products").find(".col-xs-6").removeClass("col-xs-6")),
                jQuery(window).width() > 760 ? jQuery("#zoom_03").elevateZoom({
                    gallery: "gallery_01", cursor: "move",
